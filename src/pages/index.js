...
const IndexPage = () => {
    return (
        <Layout>
            ...
            <section id="about" className="mt-24 sm:mt-36 md:mt-16 xl:mt-28">
            ...
            <section id="services" class="bg-white py-6 sm:py-8 lg:py-16 mt-8 sm:mt-12 lg:mt-24">
            ...
            <div class="max-w-screen-xl my-6 md:my-24 px-3 mx-auto">
                    ...
                    <div class="block rounded-lg shadow-lg bg-white">
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
                                <div class="px-6 my-4 md:py-12 md:px-12">
                                    ...
                                    <button
                                        type="button"
                                        class="inline-block px-7 py-3 bgLogoColor text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-gray-800 hover:shadow-lg focus:bg-gray-800 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out"
                ...
                {/* <section class="text-gray-600 body-font relative bg-white w-full">
                    <div class="px-5 py-24 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                                <div class="p-2 w-1/2">
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            id="name"
                                            name="name"
                                            class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-gray-800 focus:bg-white focus:ring-2 focus:ring-gray-300 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                        />
                                    </div>
                                </div>
                                <div class="p-2 w-1/2">
                                ...
                                <div class="p-2 w-full">
                                    <button class="flex mx-auto text-white bgLogoColor border-0 py-2 px-8 focus:outline-none hover:bg-gray-800 rounded text-lg">
                                        Send
                                    </button>
                                </div>
                                <div class="p-2 w-full pt-2 mt-2 border-t border-gray-200 text-center">
                                    <Link to="mailto:example@email.com" class="linkColor hoverLink">
                                        example@email.com
                                    </Link>
                                </div>
                            </div>
